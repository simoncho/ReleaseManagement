CREATE Procedure [dbo].[DevOps_Get_AutoRefresh_Value]
@ReleaseId INT
AS
BEGIN
	SET NOCOUNT ON;
	...
	SELECT TOP 1 (CASE WHEN SST.Id = 5 THEN 0 ELSE 10 END) AS AutoRefresh -- SST.id=5 : Validate Deployment, 0:Disable.
